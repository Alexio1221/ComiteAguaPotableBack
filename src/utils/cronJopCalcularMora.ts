...
// Cron job: para que se ejecute cada minuto * cada 5 minutos */5
cron.schedule('0 * * * *', async () => {
  console.log('Verificando moras...', new Date().toLocaleString());
  ...
  try {
    ...
    console.error('Error en el cron de moras:', error);
  }
});
